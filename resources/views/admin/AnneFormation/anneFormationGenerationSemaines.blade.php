...
<form id="formationForm" method="POST" action="{{route('genererSemaines')}}">
    @csrf
    ...
    <label for="anneFormationS3">Année Formation Semester 3</label>
    <input type="text" id="anneFormationS3" name="anneFormationS3" >
    
    <label for="dateDebutS3">Date de début :</label>
    <input type="date" id="dateDebutS3" name="dateDebutS3" >
    
    <label for="dateFinS3">Date de fin :</label>
    <input type="date" id="dateFinS3" name="dateFinS3" >
    <!-- Section pour ajouter les jours fériés -->
    <h2>Ajouter Les informations sur les semestres :</h2>
    <div style="display:flex;justify-content:space-around">
   <div>
   <label for="semestre1" style="margin-bottom: 8px;border:2px solid black;text-align:center">Semestre 1</label>
    
    <label for="dateDebutSemestre1">Date de début :</label>
    <input type="date" id="dateDebutSemestre1" name="dateDebutSemestre1" >
    
    <label for="dateFinSemestre1">Date de fin :</label>
    <input type="date" id="dateFinSemestre1" name="dateFinSemestre1" >
   </div>
   <div>
   <label for="semestre2" style="margin-bottom: 8px;border:2px solid black;text-align:center">Semestre 2</label>
    
    <label for="dateDebutSemestre2">Date de début :</label>
    <input type="date" id="dateDebutSemestre2" name="dateDebutSemestre2" >
    
    <label for="dateFinSemestre2">Date de fin :</label>
    <input type="date" id="dateFinSemestre2" name="dateFinSemestre2" >
   </div>
    ...
    <div id="joursFeries">
        ...
        <input type="text" id="libelle_jour_ferie" name="libelle_jour_ferie" >
...
<script>
    ...
    document.getElementById("ajouterFerieBtn").addEventListener("click", function() {
        ...
        if (joursFeriesData.length >= 2) {
            document.getElementById("genererBtn").style.display = "inline";
            document.getElementById("du").removeAttribute("");
            document.getElementById("au").removeAttribute("");
            document.getElementById("libelle_jour_ferie").removeAttribute("");
        }
    });
