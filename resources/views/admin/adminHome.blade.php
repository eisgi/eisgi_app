...
<head>
	...
	<script defer src="{{ asset('style/admin/assets/plugins/fontawesome/js/all.min.js') }}"></script>

	<!-- App CSS -->
	<link id="theme-style" rel="stylesheet" href="{{ asset('style/admin/assets/css/portal.css') }}">

</head>

<body class="app">

    @include('frontend.components.adminHeader')
	...
	<script src="{{ asset('style/admin/assets/plugins/popper.min.js') }}"></script>
	<script src="{{ asset('style/admin/assets/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
	<!-- Charts JS -->
	<script src="{{ asset('style/admin/assets/plugins/chart.js/chart.min.js') }}"></script>
	<script src="{{ asset('style/admin/assets/js/index-charts.js') }}"></script>


	<!-- Page Specific JS -->
	<script src="{{ asset('style/admin/assets/js/app.js') }}"></script>
